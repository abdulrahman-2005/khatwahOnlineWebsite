...
export default function ProductsClient({ productsAr, productsEn }) {
  ...
  const renderMobileIcon = (slug, accent) => {
    switch (slug) {
      case 'company-websites':
        return <MonitorSmartphone size={80} color={accent} strokeWidth={1.5} />;
      case 'management-systems':
        return <LayoutDashboard size={80} color={accent} strokeWidth={1.5} />;
      case 'digital-marketing':
        return <Megaphone size={80} color={accent} strokeWidth={1.5} />;
      default:
        return <LayoutDashboard size={80} color={accent} strokeWidth={1.5} />;
    }
  };
  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: "var(--color-background)" }}>
      ...
      {/* Hero Section */}
      <section className="relative px-6 pt-32 pb-20 sm:px-12 sm:pt-40 sm:pb-32 lg:px-20 overflow-hidden">
                  ...
                  <Reveal direction="up" distance={40} delay={200}>
                    <div className="flex flex-col">
                      <div className="mb-6 flex items-center gap-4">
                        ...
                        <div 
                          className="md:hidden flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl shadow-lg"
                          style={{ 
                        ...
                        >
                          {/* Use a smaller icon size to fit the neat box */}
                          {(() => {
                            const IconComponent = renderMobileIcon(product.slug, accent).type;
                            return <IconComponent size={32} color={accent} strokeWidth={2} />;
                          })()}
                        </div>
                      </div>

    ...
    <section className="relative w-full px-6 py-20 sm:px-12 sm:py-32 lg:px-20 border-y-2" style={{ backgroundColor: "var(--color-ink)", borderColor: "var(--color-border-strong)" }}>
      ...
      <div className="relative mx-auto max-w-3xl text-center z-10">
        <Reveal direction="up" distance={20}>
          <h2 className="text-4xl font-black leading-tight sm:text-5xl lg:text-6xl" style={{ color: "var(--color-text-on-dark)", letterSpacing: "-1px" }}>
            {i18n[locale].mission_statement.headline}
          </h2>
        </Reveal>
        <Reveal direction="up" distance={20} delay={150}>
          <p className="mt-8 text-xl leading-relaxed sm:text-2xl font-medium" style={{ color: "var(--color-text-on-dark-muted)" }}>
